seed:
	...
	python src/manage.py createcontacts
	python src/manage.py createmainpage
	python src/manage.py createpages
	python src/manage.py createschedule
	python src/manage.py createtickets
